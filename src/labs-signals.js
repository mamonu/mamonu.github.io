...
const records = [
  ...
  { id: 'noisering', kind: 'infobit', title: 'Wiard Noisering', summary: 'Module information and history for a landmark source of musical uncertainty.', url: 'https://mamonulabs.github.io/infobits/noisering', depth: 0.64, position: [-0.72, -0.12, 0.14], pulse: 0.92 },
  { id: 'nlc-sloth', kind: 'infobit', title: 'NLC Sloth', summary: 'Ultra-slow chaos generators whose voltages evolve over minutes and hours.', url: 'https://mamonulabs.github.io/infobits/nlc-sloth', depth: 0.70, position: [0.22, 0.62, -0.16], pulse: 0.80 },
  { id: 'wogglebug', kind: 'infobit', title: 'Wogglebug', summary: 'A history of random voltage generation from Wiard to modern interpretations.', url: 'https://mamonulabs.github.io/infobits/wogglebug', depth: 0.76, position: [0.74, -0.28, 0.08], pulse: 1.12 },
  { id: 'bananalogue-vcs', kind: 'infobit', title: 'Bananalogue VCS', summary: 'Voltage-controlled slopes, patch ideas and sounds descended from the Serge DUSG.', url: 'https://mamonulabs.github.io/infobits/bananalogue-vcs', depth: 0.82, position: [-0.36, 0.54, 0.16], pulse: 0.88 },
  { id: 'all-infobits', kind: 'infobits-index', title: 'All Infobits', summary: 'Deep dives into synthesizer modules, music technology and gear history.', url: 'https://mamonulabs.github.io/infobits', depth: 0.88, position: [0.38, -0.58, -0.12], pulse: 1.22 },
];
...
export function assertValidCatalogue(signals) {
  const ids = new Set();
  const kinds = new Set(['plugin', 'infobit', 'infobits-index']);
